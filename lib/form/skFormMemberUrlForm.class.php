 ...
 *
 */
class skFormMemberUrlForm extends skFormMemberForm implements skCustomFormMemberWidget
{
    function configure()
    {
    ...
    {
        $validator = new skCustomValidatorUrl(array('required' => (boolean)$member->required));
